...
export const AboutUs: React.FC = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center absolute md:top-44 px-4 sm:px-0 top-24">
            <div className="flex flex-col items-center   ">
                ...
                <div className="md:mt-16 flex sm:flex-col md:flex-row justify-center space-x-0 sm:space-x-8 md:space-x-24 mt-8">
                    <div className="flex flex-col items-center mb-8 sm:mb-0">
                        ...
                        />
                        <h4 className=" sm:text-base md:text-2xl sm:font-medium md:font-semibold mb-2 mt-3 text-center">NO.1 in Kerala</h4>
                        <p className="text-gray-500 text-center text-sm sm:text-sm">We are the number one authorized company in Kerala</p>
                    </div>
                    <div className="flex flex-col items-center mb-8 sm:mb-0">
                        <Image
                            ...
                            className="sm:w-12 sm:h-12"
                        />
                        <h4 className=" sm:text-base md:text-2xl sm:font-medium md:font-semibold mb-2 mt-3 text-center">540+ Works Completed</h4>
                        <p className="text-gray-500 text-center text-sm sm:text-sm">A group of people with passion towards green energy</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            className="sm:w-12 sm:h-12"
                        />
                        <h4 className="sm:text-base md:text-2xl sm:font-medium md:font-semibold mb-2 mt-3 text-center">64 Major Clients</h4>
                        <p className="text-gray-500 text-center text-sm sm:text-sm">We are the number one authorized company in Kerala</p>
                    </div>
                </div>
